  ...
  const web2Experience = [
    ...
    },
    {
      ...
      responsibilities: [
        ...
        'Building AION (aionchain.app) — a multi-chain smart money platform tracking on-chain wallet activity, whale movements, DEX flows, and Polymarket signals across Solana and EVM chains, surfacing high-conviction setups in real time.',
    ...
    },
    {
      ...
      responsibilities: [
        ...
        'Coached and mentored Level 1 Technical Support Analysts through scorecards, training sessions, and daily guidance on backend operations, database backups, quorum management, and scrum testing.',
        'Led complex client support cases across phone, chat, and email for 500+ business accounts.',
        'Managed backend operations including overnight appointments, database backups, and software/hardware testing across client environments.',
        'Drove team efficiency through structured analysis, reporting, and hands-on escalation support.',
      ],
